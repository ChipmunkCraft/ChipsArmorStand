package com.deoxservices.chipsarmorstand.world.item;
...
public enum ItemDisplayContext implements StringRepresentable, net.neoforged.fml.common.asm.enumextension.IExtensibleEnum {
    ...
    private ItemDisplayContext(int p_id, String p_name, @org.jetbrains.annotations.Nullable String fallbackName) {
        this.id = (byte)p_id;
        this.name = p_name;
        this.isModded = true;
