package com.deoxservices.chipsarmorstand.client.config;
    ...
    public static class Config {
        ...
        Config(ModConfigSpec.Builder builder) {
            ...
            ARMOR_STAND_MENU_MODIFIER = builder
                ...
                .translation("gui.chipsarmorstand.config.ARMOR_STAND_MENU_MODIFIER")
                .defineEnum("ARMOR_STAND_MENU_MODIFIER", ModifierKey.SHIFT);
            /*DEBUG = builder
                .comment("Enable debugging. Default: false")
                .translation("gui.chipsarmorstand.config.DEBUG")
                .define("DEBUG", true);*/
            ...
            .translation("gui.chipsarmorstand.config.CURIOS_ITEMS")
