package com.deoxservices.chipsarmorstand.client.gui.screen;

import com.deoxservices.chipsarmorstand.ChipsArmorStand;
import com.deoxservices.chipsarmorstand.menu.ArmorStandMenu;
import com.deoxservices.chipsarmorstand.network.ToggleArmorStandPacket;
...
public class ArmorStandScreen extends AbstractContainerScreen<ArmorStandMenu> {
    ...
    protected void init() {
        ...
        lockedCheckbox = Checkbox.builder(Component.translatable("gui.chipsarmorstand.locked"), minecraft.font)
            .pos(this.leftPos + 172, this.topPos + 110)
            .maxWidth(60)
            .selected(armorStand.getData(ChipsArmorStand.ARMOR_STAND_DATA.get()).isLocked())
        ...
        invisibleCheckbox = Checkbox.builder(Component.translatable("gui.chipsarmorstand.invisible"), minecraft.font)
        ...
        showArmsCheckbox = Checkbox.builder(Component.translatable("gui.chipsarmorstand.show_arms"), minecraft.font)
        ...
        noBasePlateCheckbox = Checkbox.builder(Component.translatable("gui.chipsarmorstand.no_base"), minecraft.font)
            ...
            .onValueChange((checkbox, value) -> {
                ...
                smallCheckBox = Checkbox.builder(Component.translatable("gui.chipsarmorstand.is_small"), minecraft.font)
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, Component.translatable("gui.chipsarmorstand.player_hot_bar"), 8, 145, 4210752, false);
        guiGraphics.drawString(this.font, Component.translatable("gui.chipsarmorstand.stand_hot_bar"), 8, 173, 4210752, false);
    }
