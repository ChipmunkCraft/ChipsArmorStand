package com.deoxservices.chipsarmorstand.data;
...
import com.deoxservices.chipsarmorstand.utils.CodecUtil;
...
public class ArmorStandData {
    ...
    public static boolean isArmorStandLocked(ArmorStand armorStand, UUID playerUUID) {
        ArmorStandData data = armorStand.getData(ChipsArmorStand.ARMOR_STAND_DATA.get());
    ...
    public static boolean lockArmorStand(ArmorStand armorStand, UUID playerUUID, boolean lock) {
        ArmorStandData data = armorStand.getData(ChipsArmorStand.ARMOR_STAND_DATA);
        data.set("Locked", lock);
        if (lock) data.set("Owner", playerUUID);
        else data.set("Owner", null);
        armorStand.setData(ChipsArmorStand.ARMOR_STAND_DATA, data);
